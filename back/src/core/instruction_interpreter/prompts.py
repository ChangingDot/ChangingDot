...
one_liner_edits_template = """## USER: Resolve the following compilation error :
"{error}"

This error is extracted from the {programming_language} file called "{file_name}".
Please follow the following instructions {solution}
Here is the only line that needs to be modified :
"{content}" :
"""
